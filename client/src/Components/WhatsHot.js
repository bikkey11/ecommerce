...
import { WhatsHotProduct } from '../Data/product'
        ...
        <div className='mx-10'>
            <div className='flex flex-col gap-2'>
               ...
               <h1 className='text-2xl font-Poppins font-bold text-indigo-900'>
                ...
                <FaFire className='text-2xl text-red-700'/>
               </div>
            
                <div className='pt-4'>
                    <div className='grid grid-cols-4 gap-3'>
                        {WhatsHotProduct.map((product, index) => (
                            <div key={index} className='flex flex-col h-34 sm:h-44 overflow-hidden rounded-md hover:shadow-2xl hover:border-4 cursor-pointer justify-between'>
